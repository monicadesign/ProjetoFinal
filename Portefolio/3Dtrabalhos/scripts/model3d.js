    ...
    constructor(){
        ...
        function setUp3DEnvironment(){
            ...
            let createScene = function () {
                ...
                scene.createDefaultLight(false, false, false);
               
                var camera = new BABYLON.ArcRotateCamera("Camera", -Math.PI / 2,  Math.PI / 4, 26, new BABYLON.Vector3(6,-20,3), scene);
                //var camera = new BABYLON.UniversalCamera("camera", new BABYLON.Vector3(-8, 15, -10), scene);
